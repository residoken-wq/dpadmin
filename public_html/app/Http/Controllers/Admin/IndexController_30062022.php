    ...
    public function edit($id, Request $request)
    {
        if ($request->isMethod("post")) {
            ...
            if ($validator->fails()) {
                ...
                $Up_Customer->approved = (isset($request->approved)) ? $request->approved : 1;
...
//                }
                $UP_Supplier->approved_2 = (isset($request->approved_2)) ? 2 : 1;
...
//                DTPhieuchi::where('flag', 0)->where("cid_form", $TUpdated->id)->delete();
                ...
                $_phieuchi = DTPhieuchi::where("cid_form", $TUpdated->id)->get();
