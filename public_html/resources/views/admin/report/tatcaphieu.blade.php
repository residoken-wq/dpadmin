                                     ...
                                     <table class="table table-sm  table-bordered table-striped dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> {{ App\MrData::toPrice($list->mytong)}}</td>

                                                <td> {{ App\MrData::toPrice($list->mytamung)}}</td>
                                           ...
                                           // /admin/supplier/export{{$u}}
                                            ...
                                            ?>
                                                 ...
                                                 <a target="_black" style="font-size:12px;padding: 2px " class="btn btn-xs btn-success" href='/admin/report/danhsachtatcaphieu/{{$value}}{{$u}}'><i class="fa fa-edit"></i> Danh sách Phiếu Thu  </a></th> 
