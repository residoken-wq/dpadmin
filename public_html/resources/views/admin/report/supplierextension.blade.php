...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="">Quản lý Công nợ của NCC PHÍ DỊCH THUẬT </a>
        </li>
    </ol>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        NCC: {{App\MrData::toPrice($tongso)}} <span
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a style="font-size:12px;padding: 2px " target="_black"
                                       ...
                                       href='/admin/report/supplierextensionlist/<?php echo $list['cid_supplier'];?>?<?php echo implode("&", $uu)?>'><i
