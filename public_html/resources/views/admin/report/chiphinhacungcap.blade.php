@extends("admin.admin")
 @section('content')
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="">BÁO CÁO CHI PHÍ THEO NHÀ CUNG CẤP  </a>
                </li>
            ...
            <div class="row view_search" >
                    <div class="col-sm-12">
                                     <div class="form-group">
                                                    <label for="name">CHI PHÍ THEO NHÀ CUNG CẤP : </label>
 
  {!! Form::select('supplier',$dsncc,@$search['supplier'],['class'=>"form-control" ,"autocomplete"=>"off"]) !!}                                                  
                                                </div>
                                            </div>

                                  <div class="col-sm-3">
                                     <div class="form-group">
                                                    <label for="name">Báo cáo theo : </label>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> {{@$detail_supplier['name']}} : 
                                        @if(count((array)$tongds)>0)
                                        {{App\MrData::toPrice($tongds->total)}}
                                        @endif
                                     ...
                                     <table class="table table-sm  table-bordered table-striped dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> {{ App\MrData::toPrice($list->total)}}
                                                <th>  
                                                ...
                                                if(empty($u)){
                                                 // $u="?supplier=".$detail_supplier['id'];
                                                }else{
                                                   $u=$u."&supplier=".$detail_supplier['id'];
                                                }
                                           ...
                                           // /admin/supplier/export{{$u}}
                                            ...
                                            ?>
                                                 ...
                                                 <a target="_black" style="font-size:12px;padding: 2px " class="btn btn-xs btn-success" href='/admin/report/danhsachchiphinhacungcap/{{$value}}{{$u}}'><i class="fa fa-edit"></i> Danh sách Phiếu Chi  </a></th> 
