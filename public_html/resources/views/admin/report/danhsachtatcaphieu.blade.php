@extends("admin.admin")
 @section('content')
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="">Quản lý phiếu dịch: {{$value}} </a>
                </li>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> Danh Sách Phiếu {{$value}} <span class="badge badge-pill badge-danger"> {{$data_list->total()}}</span>
                                </div>
                                    ...
                                    <table class="table table-sm  table-bordered table-striped dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($list['approved']=='1')
                                                        <label style="font-size:10px;" class="badge badge-secondary ajax_pending" idx="{{$list['id']}}">PENDING</label>
                                                    @endif
                                                    @if($list['approved']=='2')
                                                ...
                                                <td>
                                                    ...
                                                    @if($list['approved']=='1' && $is_delete)
                                                        ...
                                                        <a style="font-size:12px;padding: 2px 2px" class="btn btn-xs btn-danger click_remove " href='/admin/index/removed/<?php echo $list['id'];?>?_token={{csrf_token()}}' target="_black"> <i class="fa fa-remove"></i> REMOVE    </a>
