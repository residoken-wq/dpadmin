        ...
        <div class="row view_search">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {!! Form::select('is_customer',$is_customer,@$search['is_customer'],['class'=>"form-control is_customer" ]) !!}
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="name">Tên KH: </label>
                    {!! Form::select('cid_customer',$cid_customer,@$search['cid_customer'],['class'=>"form-control cid_customer" ]) !!}
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {!! Form::select('cid_customer_kl',$cid_customer_kl,@$search['cid_customer_kl'],['class'=>"form-control cid_customer" ]) !!}
                </div>
            </div>
            <div class="col-sm-2">
                <div class="form-group">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    {!! Form::text('ngaytrahoso',@$search['ngaytrahoso'],['class'=>"form-control" ,'id'=>'ngaytrahoso',"autocomplete"=>"off"]) !!}
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    ...
                    {!! Form::select('cid_buoi',$cid_listbuoi,@$search['cid_buoi'],['class'=>"form-control" ,'id'=>'cid_buoi',"autocomplete"=>"off"]) !!}
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        Hành: {{App\MrData::toPrice($tongso['total'])}} <span
