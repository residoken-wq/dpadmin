@extends("admin.admin")
 @section('content')
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="">BÁO CÁO CHI PHÍ  </a>
                </li>
            ...
            <div class="row view_search" >
                                  ...
                                  <div class="col-sm-3">
                                     <div class="form-group">
                                                    <label for="name">CHI PHÍ theo: </label>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> CHI PHÍ : 
                                        ...
                                        <tbody>
                                           ...
                                           // /admin/supplier/export{{$u}}
                                            ...
                                            ?>
                                                 ...
                                                 <a target="_black" style="font-size:12px;padding: 2px " class="btn btn-xs btn-success" href='/admin/report/danhsachchiphi/{{$value}}{{$u}}'><i class="fa fa-edit"></i> Danh sách Phiếu Chi  </a></th> 
