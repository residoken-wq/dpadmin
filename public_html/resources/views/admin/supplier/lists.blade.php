                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> Danh Sách Nhà Cung cấp <span class="badge badge-pill badge-danger"> {{$data_list->total()}}</span> 
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-sm btn-danger click_remove" href='/admin/supplier/remove?id=<?php echo $list['id'];?>&_token={{csrf_token()}}'> <i class="fa fa-remove"></i> Xoá  </a>
                                                    @endif
                                                </td>
