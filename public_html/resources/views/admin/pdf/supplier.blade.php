            ...
            <div class="main">
                ...
                <article>
                    ...
                    <table style="text-align: center; border: 0.5px solid black">
                        ...
                        <tr>
                            <td class="table-border">{{App\MrData::toPricePrint($OrderCustomer['phidichthuat'])}} </td>
                            <td class="table-border">{{App\MrData::toPricePrint($OrderCustomer['congchung'])}} </td>
                            <td class="table-border">{{App\MrData::toPricePrint($OrderCustomer['daucongty'])}} </td>
                            <td class="table-border">{{App\MrData::toPricePrint($OrderCustomer['saoy'])}} </td>
                            <td class="table-border">{{App\MrData::toPricePrint($OrderCustomer['ngoaivu'])}} </td>
                            <td class="table-border">{{App\MrData::toPricePrint($OrderCustomer['phivanchuyen'])}} </td>
                            <td class="table-border">{{App\MrData::toPricePrint($OrderCustomer['tong'])}} </td>
                        </tr>

                        <tr class="table-border">
                          <td colspan="6" style="text-align: right">VAT </td>
                          <td class="table-border">{{App\MrData::toPricePrint($OrderCustomer['vat'])}} </td>
                        </tr>
                        ...
                        <tr class="table-border">
                          ...
                          <td class="table-border">{{App\MrData::toPricePrint($OrderCustomer['tamung'])}} </td>
                        </tr>

                        <tr class="table-border">
                          <td colspan="6" style="text-align: right">Còn lại </td>
                          <td class="table-border">{{App\MrData::toPricePrint($OrderCustomer['conglai'])}} </td>
                        </tr>
