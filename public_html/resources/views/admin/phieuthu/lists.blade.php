@extends("admin.admin")
 ...
 {!! Form::text('customer',@$search['customer'],['class'=>"form-control col-sm-12" ]) !!}
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> Danh Sách Phiếu thu <span class="badge badge-pill badge-danger"> {{$data_list->total()}}</span> 
                                </div>
