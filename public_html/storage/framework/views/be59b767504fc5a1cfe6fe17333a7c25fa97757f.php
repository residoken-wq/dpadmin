 <?php $__env->startSection('content'); ?>
  ...
  <?php echo Form::select('supplier',$dsncc,@$search['supplier'],['class'=>"form-control" ,"autocomplete"=>"off"]); ?>                                                  
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> <?php echo e(@$detail_supplier['name']); ?> : 
                                        ...
                                        <tbody>
                                           ...
                                           // /admin/supplier/export{{$u}}
                                            ...
                                            ?>
                                                 ...
                                                 <a target="_black" style="font-size:12px;padding: 2px " class="btn btn-xs btn-success" href='/admin/report/danhsachchiphinhacungcap/<?php echo e($value); ?><?php echo e($u); ?>'><i class="fa fa-edit"></i> Danh sách Phiếu Chi  </a></th> 
