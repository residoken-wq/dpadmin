 <?php $__env->startSection('content'); ?>
  ...
  <?php echo Form::select('customer',$customer,@$search['customer'],['class'=>"form-control cid_customer" ,"autocomplete"=>"off"]); ?>                                                  
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> DOANH SỐ  : <strong class="text text-danger"> <?php echo e($cus['name']); ?> </strong>  ( <?php echo e($cus['is_kl']=='2'?' Khách Lẻ':'Khách hàng '); ?>)
                                     ...
                                     <table class="table table-sm  table-bordered table-striped dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php echo e(App\MrData::toPrice($thu['tong'])); ?>


                                                </td>
                                                <td>  
                                                  <?php echo e(App\MrData::toPrice($thu['tamung'])); ?>

                                                   </td> 
                                                     <td>  
                                                  
                                                 
                                                    <?php echo e(App\MrData::toPrice($thu['total'])); ?>
                                          ...
                                          <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td >
                                                 ...
                                                 <?php echo e(App\MrData::toPrice($total['tong'])); ?>
                                            ...
                                            <tr>
                                               <th> Tam ứng  </th> 
                                                <td>  
                                                  <h5  class="text text-primary">
                                                  <?php echo e(App\MrData::toPrice($total['tamung'])); ?>
                                            ...
                                            <tr>
                                              <th>  Tổng </th> 
                                                  ...
                                                  <h5  class="text text-primary">
                                                    ...
                                                    <?php echo e(App\MrData::toPrice($total['total'])); ?>
