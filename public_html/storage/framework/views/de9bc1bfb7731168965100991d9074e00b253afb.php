 ...
 <?php echo Form::text('name',@$search['name'],['class'=>"form-control" ]); ?>
 ...
 <?php echo Form::select('is_kl',$is_kl,@$search['is_kl'],['class'=>"form-control" ]); ?>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> Danh Sách Khách Hàng<span class="badge badge-pill badge-danger"> <?php echo e($data_list->total()); ?></span> 
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-sm btn-danger click_remove" href='/admin/customer/remove?id=<?php echo $list['id'];?>&_token=<?php echo e(csrf_token()); ?>'> <i class="fa fa-remove"></i> Xoá  </a>
                                                    <?php endif; ?>
                                                </td>
