        ...
        <div class="row view_search">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <?php echo Form::text('barcode',@$search['barcode'],['class'=>"form-control",'id'=>'barcode' ]); ?>
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <table class="table table-sm  table-bordered table-striped dataTable">
                            ...
                            <?php $s = $k = $tt_kh = 0;?>
                            <tbody>
                            <?php $__currentLoopData = $data_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                <tr>
                                    <td><?php echo e($list['code']); ?></td>
                                    <td>
                                        Tên Khách: <?php echo e($list->Customer()->name); ?> <br/>
                                        Tên Trong Hồ Sơ: <?php echo e($list['name_docs']); ?><br/>
                                        Tài liệu: <?php echo e($list['name']); ?>
                                    ...
                                    <td>
                                        <?php if($list['approved']=='1'): ?>
                                            <label style="font-size:10px;" class="badge badge-secondary ajax_pending"
                                                   idx="<?php echo e($list['id']); ?>">PENDING</label>
                                        <?php endif; ?>
                                        ...
                                        Tổng: <?php echo e(App\MrData::toPrice((int)$list->OrderSupplier()[0]['tong']+(int)$list->OrderCustomer()[0]['tong'])); ?>
                                    ...
                                    <td>
                                        ...
                                        <br/>
                                        Tổng: <?php echo e(App\MrData::toPrice($total_ncc)); ?>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        Tổng: <?php echo e(App\MrData::toPrice($total_ttkh)); ?>
                                    ...
                                    <td>
                                        ...
                                        <a style="font-size:12px;padding: 2px  " class="btn btn-xs btn-secondary "
                                           href='/admin/index/pdf/<?php echo $list['id'];?>&_token=<?php echo e(csrf_token()); ?>'
                                        ...
                                        <?php if($list['approved']=='1' && $is_delete): ?>
                                            ...
                                            <a style="font-size:12px;padding: 2px 2px"
                                               ...
                                               href='/admin/index/removed/<?php echo $list['id'];?>?_token=<?php echo e(csrf_token()); ?>'
                                    ...
                                    <td>
                                        <?php if((int)$list->OrderSupplier()[0]['approved']==1): ?>
                                            <a style="font-size:12px;padding: 2px  "
                                               class="btn btn-xs btn-primary approvedcustomer_click "
                                               href='/admin/index/approvedsupplier/<?php echo $list['id'];?>&_token=<?php echo e(csrf_token()); ?>'
                                    ...
                                    <td>
                                        <?php if((int)$list->OrderCustomer()[0]['approved']==1): ?>
                                            <a style="font-size:12px;padding: 2px  "
                                               class="btn btn-xs btn-info approvedcustomer_click "
                                               href='/admin/index/approvedcustomer/<?php echo $list['id'];?>&_token=<?php echo e(csrf_token()); ?>'
                                               target="_black"> <i class="fa fa-check"></i> Đã nhận </a>
                                        <?php endif; ?>
                                    ...
                                    <td class="text-center">
                                        <?php if( (int)$list->OrderSupplier()[0]['approved']==1): ?>
                                            <input type="checkbox"
                                                   ncc='/admin/index/approvedsupplier/<?php echo $list['id'];?>&_token=<?php echo e(csrf_token()); ?>'
                                                   class="list_check_box" idx="<?php echo e($list['id']); ?>"/>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <?php if((int)$list->OrderCustomer()[0]['approved']==1 ): ?>
                                            <input type="checkbox"
                                                   kh='/admin/index/approvedcustomer/<?php echo $list['id'];?>&_token=<?php echo e(csrf_token()); ?>'

                                                   class="list_check_box_kh" idx="<?php echo e($list['id']); ?>"/>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <strong><?php echo e(App\MrData::toPrice($k+$s)); ?></strong>
                                    </td>
                                    <td>
                                        <strong><?php echo e(App\MrData::toPrice($s)); ?></strong>
                                    </td>
                                    <td>
                                        <strong><?php echo e(App\MrData::toPrice($tt_kh)); ?></strong>
                                    </td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
