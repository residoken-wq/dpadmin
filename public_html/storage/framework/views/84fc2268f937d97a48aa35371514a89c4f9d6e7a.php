        ...
        <div class="row view_search">
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <?php echo Form::text('name_docs',@$search['name_docs'],['class'=>"form-control" ]); ?>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <?php echo Form::select('approved',$approved,@$search['approved'],['class'=>"form-control select_flex" ]); ?>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <?php echo Form::select('cid_customer',$cid_customer,@$search['cid_customer'],['class'=>"form-control select_flex" ]); ?>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <?php echo Form::select('cid_supplier',$cid_supplier,@$search['cid_supplier'],['class'=>"form-control select_flex" ]); ?>

                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    <?php echo Form::text('cid_id',@$search['cid_id'],['class'=>"form-control" ,'placeholder'=>'Barcode']); ?>
                    ...
                    <div class="card-block">
                        <table class="table table-sm table-bordered table-striped dataTable">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e(App\MrData::toPricePrint($OrderSupplier->tong)); ?>
                                    ...
                                    <?php if($OrderSupplier['approved']=='2' && $OrderSupplier['approved_2']=='2'): ?>
                                        ...
                                        <div><label style="font-size:10px;" class="badge badge-success"
                                                    data-toggle="tooltip" title="DONE"><i
                                                        class="fa fa-circle text-success"></i></label> <?php echo e(App\MrData::toPricePrint($OrderSupplier->phidichthuat)); ?>

                                        </div>
                                    <?php else: ?>
                                        <div><label style="font-size:10px;" class="badge badge-secondary"
                                                    data-toggle="tooltip" title="PENDING"><i
                                                        class="fa fa-circle text-secondary"></i></label> <?php echo e(App\MrData::toPricePrint($OrderSupplier->phidichthuat)); ?>
                                ...
                                <td>
                                    <?php $__currentLoopData = $list->OrderCustomer(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $OrderCustomer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($OrderCustomer['approved']=='1'): ?>
                                            <div><label style="font-size:10px;" class="badge badge-secondary"
                                                        data-toggle="tooltip" title="PENDING"><i
                                                            class="fa fa-circle text-secondary"></i></label> <?php echo e(App\MrData::toPricePrint($list->tong)); ?>
                                        ...
                                        <?php if($OrderCustomer['approved']=='2'): ?>
                                            ...
                                            <div><label style="font-size:10px;" class="badge badge-success"
                                                        data-toggle="tooltip" title="DONE"><i
                                                            class="fa fa-circle text-success"></i></label> <?php echo e(App\MrData::toPricePrint($list->tong)); ?>
                                ...
                                <td>
                                    ...
                                    <?php if(Auth::user()->roles=='1'): ?>
                                        <?php if(isset($list['locked']) && $list['locked']): ?>
                                            <a href="/admin/index/unlock/<?php echo e($list['id']); ?>"
                                        ...
                                        <?php else: ?>
                                            <a href="/admin/index/lock/<?php echo e($list['id']); ?>"
                                               style="font-size:12px;padding: 2px " data-toggle="tooltip"
