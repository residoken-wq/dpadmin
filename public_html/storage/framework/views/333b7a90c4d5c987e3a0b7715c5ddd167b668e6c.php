 <?php $__env->startSection('content'); ?>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="">Tạo mới Quản Trị Viên   </a>
                </li>
 ...
 <?php echo Form::text('username',@$data['username'],['class'=>"form-control ", "placeholder"=>""  ]); ?>
 ...
 <?php echo Form::select('roles', $roles,@$data['roles'],['class'=>"form-control ", "placeholder"=>""  ]); ?>
                ...
                <?php echo Form::textarea('note',@$data['note'],['class'=>'form-control','rows'=>4]); ?>
