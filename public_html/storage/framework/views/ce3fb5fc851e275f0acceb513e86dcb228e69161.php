<?php $__env->startSection('content'); ?>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="">Phiếu dịch của NCC PHÍ DỊCH THUẬT : <?php echo e($supplier['name']); ?></a>
        </li>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a style="font-size:12px;padding: 2px  "
                                       ...
                                       href='/admin/index/approvedsupplierextension/<?php echo $list['id'];?>&_token=<?php echo e(csrf_token()); ?>'
                                ...
                                <td class="text-center">
                                    <input type="checkbox"
                                           value='/admin/index/approvedsupplierextension/<?php echo $list['id'];?>&_token=<?php echo e(csrf_token()); ?>'
