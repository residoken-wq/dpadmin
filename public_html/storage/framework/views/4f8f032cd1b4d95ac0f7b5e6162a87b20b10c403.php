<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::open(['method'=>'post','class'=>'s', 'name' => 'formPhieu']); ?>
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type='text' class="form-control" value="<?php echo e(@$data['code']); ?>" disabled="disabled"/>
                                <?php echo Form::hidden('code',@$data['code'],['class'=>'form-control']); ?>
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo Form::text('mydate',date('d/m/Y'),['class'=>'form-control','Disabled'=>'Disabled']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <?php echo Form::select('cid_customer',$cid_customer,@$data['cid_customer'],['class'=>'form-control cid_customer']); ?>
                                ...
                                <?php if($errors->has("cid_customer")): ?>
                                    <div class="alert alert-danger invalid-feedback" role="alert">
                                        * <?php echo e($errors->first("cid_customer")); ?></div>
                                <?php endif; ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <?php echo Form::select('cid_supplier',$cid_supplier,@$data['cid_supplier'],['class'=>'form-control cid_supplier' ]); ?>

                                </div>
                                <?php if($errors->has("cid_supplier")): ?>
                                    <div class="alert alert-danger invalid-feedback" role="alert">
                                        * <?php echo e($errors->first("cid_supplier")); ?></div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-xs-8 col-sm-8">
                                        <?php echo Form::text('name',@$data['name'],['class'=>'form-control','placeholder'=>"Diễn giải "]); ?>

                                    </div>
                                    <div class="col-xs-4 col-sm-4">
                                        <?php echo Form::text('name_number',@$data['name_number'],['class'=>'form-control inputNumber',"placeholder"=>"Số lượng"]); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo Form::text('name_docs',@$data['name_docs'],['class'=>'form-control']); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <?php echo Form::text('path_work',@$data['path_work'],['class'=>'form-control']); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo Form::textarea('ghichu',@$data['ghichu'],['class'=>'form-control ','rows'=>'4`']); ?>
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo Form::text('phone',@$data['phone'],['class'=>'form-control','id'=>'phone']); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo Form::text('sobandich',@$data['sobandich'],['class'=>'form-control']); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class='col-xs-8 col-sm-8'>
                                        <div class='input-group'>
                                            <?php echo Form::text('ngaytrahoso',@$data['ngaytrahoso'],['class'=>'form-control ngaytrahoso']); ?>
                                    ...
                                    <div class='col-xs-4 col-sm-4'>
                                        <div class='input-group'>
                                            <?php echo Form::text('giotrahoso',@$data['giotrahoso'],['class'=>'form-control giotrahoso']); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <?php echo Form::text('phidichthuat',@$data['phidichthuat'],['class'=>'form-control my_price element_price inputNumber','id'=>'phidichthuat']); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <?php echo Form::text('congchung',@$data['congchung'],['class'=>'form-control my_price element_price inputNumber','id'=>'congchung']); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <?php echo Form::text('daucongty',@$data['daucongty'],['class'=>'form-control my_price element_price inputNumber','id'=>'daucongty']); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <?php echo Form::text('saoy',@$data['saoy'],['class'=>'form-control my_price element_price inputNumber','id'=>'saoy']); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <?php echo Form::text('ngoaivu',@$data['ngoaivu'],['class'=>'form-control my_price element_price inputNumber','id'=>'ngoaivu']); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <?php echo Form::text('phivanchuyen',@$data['phivanchuyen'],['class'=>'form-control my_price element_price inputNumber','id'=>'phivanchuyen']); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <?php echo Form::text('vat',@$data['vat'],['class'=>'form-control my_price element_price inputNumber']); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <?php echo Form::text('tong',@$data['tong'],['class'=>'form-control total_price inputNumber','id'=>'tong']); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <?php echo Form::text('tamung',@$data['tamung'],['class'=>'form-control tamung_price inputNumber','id'=>'tamung']); ?>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <?php echo Form::text('conglai',@$data['conglai'],['class'=>'form-control conglai_price inputNumber','id'=>'conglai']); ?>
