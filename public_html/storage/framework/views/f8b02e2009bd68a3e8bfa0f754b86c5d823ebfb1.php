...
<?php $__env->startSection('content'); ?>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="">Phiếu dịch của KH: <?php echo e($customer['name']); ?></a>
        </li>
    ...
    <div class="container-fluid">
        <?php echo Form::open(['method'=>'post','id'=> 'frmCustomerList',"url"=>url()->full()]); ?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Danh Sách Phiếu của KH: <?php echo e($customer['name']); ?> <span
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a style="font-size:12px;padding: 2px  "
                                       class="btn btn-xs btn-primary approvedcustomer_click approvedcustomer_click_<?php echo e($list['id']); ?> "
                                ...
                                <td class="text-center">
                                    <input type="checkbox"
                                           value="/admin/index/approvedcustomer/<?php echo $list['id'];?>&_token=<?php echo e(csrf_token()); ?>"
                                           class="list_check_box" idx="<?php echo e($list['id']); ?>" data-id="<?php echo e($list['id']); ?>"
