 <?php $__env->startSection('content'); ?>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/admin/phieuchi/lists">Danh sách PHIẾU CHI   </a>
                </li>
            ...
            <div class="col-xs-12 col-sm-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong> Thông tin  PHIẾU CHI   </strong>
                                        <small>Form</small>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <label for="name">Số tiền :  </label>
                                                             ...
                                                             <div class='input-group'>
                                                                 <?php echo Form::number('price',@$data['price'],['class'=>'form-control my_price ','id'=>'price']); ?>
                        ...
                        <div class="alert alert-danger">* <?php echo e($errors->first("price")); ?></div>
                       <?php endif; ?>                    
        ...
        <?php echo Form::text('nguoichi',@$data['nguoichi'],['class'=>'form-control','autocomplete'=>'on']); ?>

                       <?php if($errors->has("nguoichi")): ?> 
                        <div class="alert alert-danger">* <?php echo e($errors->first("nguoichi")); ?></div>
                       <?php endif; ?>                          
        ...
        <?php echo Form::textarea('lydo',@$data['lydo'],['class'=>'form-control','rows'=>4]); ?>
