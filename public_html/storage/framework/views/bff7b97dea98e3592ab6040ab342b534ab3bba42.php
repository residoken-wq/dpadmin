...
<?php $__env->startSection('content'); ?>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="">Phiếu dịch của NCC PHÍ DỊCH VỤ: <?php echo e($supplier['name']); ?></a>
        </li>
    </ol>
    <div class="container-fluid">
        <?php echo Form::open(['method'=>'post',"url"=>url()->full()]); ?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Phiếu dịch của NCC: <?php echo e($supplier['name']); ?> <span
                    ...
                    <div class="card-block">
                        <table class="table table-sm  table-bordered table-striped dataTable">
                            ...
                            <tr>
                                ...
                                <td><?php echo e($list->ten_khach_hang); ?></td>
                                <td><?php echo e($list->name_docs); ?></td>
                                <td><?php echo e($list->name); ?></td>
                                <td>
                                    <?php $is_delete = !$list->is_done;?>
                                        <?php if($list->is_done): ?>
...
//                                                )-tamung) as total"))->where("cid_form", $list['id'])->first();
                                    $tongcongno = floatval($list->tongcongno);
//                                    $tongcongno = floatval($my_t);
                                    $t1 = $t1 + $tongcongno;
                                    echo App\MrData::toPrice($tongcongno);?></td>
                                <td>
                                ...
                                <td class="text-center">
                                    <input type="checkbox"
                                           value='/admin/index/approvedsupplier/<?php echo $list['id'];?>&_token=<?php echo e(csrf_token()); ?>'
