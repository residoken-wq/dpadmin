 <?php $__env->startSection('content'); ?>
                                                ...
                                                <div class="form-group">
                                                    <label for="name">Số tiền :  </label>
                                                             ...
                                                             <div class='input-group'>
                                                                 <?php echo Form::number('price',@$data['price'],[ 'min' => 0,'class'=>'form-control my_price ','id'=>'price']); ?>
        ...
        <?php echo Form::text('nguoinhantien',@$data['nguoinhantien'],['class'=>'form-control','autocomplete'=>'on']); ?>

                       <?php if($errors->has("nguoinhantien")): ?>
                        <div class="alert alert-danger">* <?php echo e($errors->first("nguoinhantien")); ?></div>
                       <?php endif; ?>
